 ...
 *	\li \link LineaBtPrinterConnection Print over Bluetooth using an IPC sled\endlink
 ...
 *  <ul>
 *      <li>The API library was built using XCode 4.5.1</li>
 *      <li>Minimum iOS SDK is 5.0</li>
 *      <li>Valid architectures are armv7 and armv7s</li>
 *      <li>Code is compiled with LLVM 4.1</li>
 ...
 *      </ul>
 *      <li>If you wish to communicate to a Bluetooth Zebra printer through an IPC sled, you need to:</li>
 *      <ul>
 *          <li>Link your project to the <b>ExternalAccessory</b> framework</li>
 *          <li>Add the <b>IPC static library</b> to your project (Please see <a href="http://ipcprint.com/">IPC</a> to obtain this library)</li>
 *          <li>Add the proper protocol string to your plist file; <b>com.datecs.linea.pro.msr</b> and <b>com.datecs.linea.pro.bar</b></li>
 *          <li>Set the key <b>Required Background modes</b> to <b>App Communicates with an accessory</b> in your app's plist file</li>
 *      </ul>
